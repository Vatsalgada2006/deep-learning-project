...
- **Database**: MongoDB Atlas free tier, logs every detection event
  (timestamp, camera ID, confidence score) for a history collection in the UI.
...
- A history/log table of past detected events pulled from MongoDB Atlas.
