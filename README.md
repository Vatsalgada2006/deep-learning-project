...
A full-stack web application that detects road accidents in real time from CCTV-style video using a CNN-LSTM deep learning model, shows live alerts on a 3D-animated dashboard, and is deployed live for free.
